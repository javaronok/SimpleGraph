...
Для проверки работы и помощи при использовании в разработке написаны тесты для ориентированно (OrientedGraphTest) и неориентированного (UndirectedGraphTest) графов.
